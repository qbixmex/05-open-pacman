// main.js
// Loop, keyboard, and screens. Uses createGame/update/draw (globals).
...
function loop() {
  ...
  if ( game.state === 'playing' ) {
    update( game );
    if ( game.state === 'won' ) showOverlay( 'YOU WIN', 'win', 'Restart' );
    else if ( game.state === 'lost' ) showOverlay( 'YOU LOSE', 'lose', 'Restart' );
  }
  draw( ctx, game, frame );
